...
MCP (Model Context Protocol) server for Veo (Google) AI video generation via AceDataCloud API.
...
core/
  ...
  types.py      — Literal types (VeoModel, etc.)
...
1. **Source of truth** — `_docs/openapi/veo.json` is the OpenAPI spec for the VeoMCP API.
