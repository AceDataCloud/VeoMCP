...
**Endpoint:** `https://veo.mcp.acedata.cloud/mc`
...
2. Enter the server URL: `https://veo.mcp.acedata.cloud/mc`
...
```json
{
  "mcpServers": {
    "veo": {
      ...
      "url": "https://veo.mcp.acedata.cloud/mc",
      "headers": {
...
# MCP initialize
curl -X POST https://veo.mcp.acedata.cloud/mc \
